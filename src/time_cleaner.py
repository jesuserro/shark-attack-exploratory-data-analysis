...
class TimeCleaner:
    ...
    def clean_time_column(self):
        ...
        if "time" in self.original_df.columns:
            ...
            mode_value = self.cleaned_df["time"].mode()[0]
            self.cleaned_df["time"] = self.cleaned_df["time"].fillna(mode_value)
